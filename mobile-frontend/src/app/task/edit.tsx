...
export default function EditTaskScreen() {
  ...
  async function loadData() {
    try {
      ...
      if (!id) {
        showMessage(
          "Error",
          "No se recibió el identificador de la tarea."
        );
  ...
  function validateForm(): boolean {
    ...
    if (
      ...
      showMessage(
        "Hora necesaria",
        "Debes indicar una hora válida para activar el recordatorio."
      );
  ...
  async function handleUpdate() {
    ...
    try {
      ...
      if (!updatedTask) {
        showMessage(
          "Error",
          "No se encontró la tarea que intentas actualizar."
        );
      ...
      showMessage(
        "Tarea actualizada",
        reminderEnabled
          ? "La tarea y su recordatorio se actualizaron correctamente."
        ...
        reminderEnabled && (
          <View style={styles.warningBox}>
            <Text style={styles.warningText}>
              En web se guardará la
              configuración, pero la
              notificación local debe probarse
              en Android o iOS.
            </Text>
          </View>
        )}
